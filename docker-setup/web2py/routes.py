...
# BASE = 'http://gateway'  # optonal prefix for incoming URLs
...
#
# routes_onerror = [
#     (r'erp/400', r'/erp/default/login')
#    ,(r'*/404', r'/erp/static/cantfind.html')
#    ,(r'erp/*', r'/erp/static/fail.html')
#    ,(r'*/*', r'/erp/static/fail.html')
# ]
